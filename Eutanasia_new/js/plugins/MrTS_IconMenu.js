...
(function() {
	...
	var descriptionList = {
		...
		'item': ["", "\\I[210]Barang yang dimiliki"],
		'skill': ["", "\\I[76]Keterampilan"],
		'equip': ["", "\\I[153]Periksa peralatan epik."],
		'status': ["", "\\I[193]Statistik"],
		'formation': ["", "\\I[82]Pengaturan party"],
		'quest': ["", "\\I[100]Melakukan Quest"],
		'options': ["", "\\I[80]Opsi"],
		'save': ["", "\\I[79]Menyimpan permainan"],
		'gameEnd': ["", "\\I[254]Keluar dari permainan"] 
	};
	/* --------------------------------------------------------------------------------
